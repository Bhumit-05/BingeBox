    ...
    return (
        <div className='p-4 relative z-10'>
            ...
            <div className='flex items-start '>
                <img 
                onClick={handleClick}
                className='w-[170px] mr-10 rounded-3xl transform transition duration-500 hover:scale-110 hover:shadow-lg hover: cursor-pointer' src={IMG_CDN_URL + movie.poster_path} alt={movie.title} />
                <div>
